 ...
 * @author dosen
 */
public final class DlgCariObat21 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariObat21(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariObat21 dialog = new DlgCariObat21(new javax.swing.JFrame(), true);
