 ...
 * @author dosen
 */
public final class DlgCariObat1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariObat1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariObat1 dialog = new DlgCariObat1(new javax.swing.JFrame(), true);
