...
import inventory.DlgCariObat21;
...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaan=new DefaultTableModel(null,new Object[]{
            ...
            "Respirasi(/menit)","Tinggi(Cm)","Berat(Kg)","SpO2(%)","GCS(E,V,M)","Kesadaran","Subjek/Situation","Objek/Background","Alergi","Asesmen","Plan",
            "Instruksi/Recomendation","Evaluasi","NIP","Dokter/Paramedis","Profesi/Jabatan"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Subjek/Situation :");
        jLabel8.setName("jLabel8"); // NOI18N
        panelGlass12.add(jLabel8);
        jLabel8.setBounds(0, 70, 70, 23);

        jLabel9.setText("Objek/Background :");
        ...
        jLabel55.setText("Instruksi/Recomendation :");
        ...
        BtnRiwayatPenunjang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
    ...
    private void BtnValidasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"No.Rawat");
        }else{    
            if(akses.getkode().equals("Admin Utama")){
                if(TabRawat.getSelectedIndex()==3){
                TEvaluasi.setText("Telah saya review dan validasi seluruh rencana dari PPA lain selama 24 jam terakhir");
            }
                simpan();
            }else{
                if(TanggalRegistrasi.getText().equals("")){
    ...
    private void BtnValidasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
        ...
        if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                if(Sequel.cariInteger("select count(stok_obat_pasien.no_rawat) from stok_obat_pasien where stok_obat_pasien.no_rawat=? ",TNoRw.getText())>0){
                    ...
                    DlgCariObat21 dlgobt=new DlgCariObat21(null,false);
                    dlgobt.setNoRm(TNoRw.getText(),TNoRM.getText(),TPasien.getText(),DTPTgl.getDate());
                    dlgobt.isCek();
                    dlgobt.tampil();
                    dlgobt.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
    ...
    */
    ...
    public void isCek(){
        ...
        BtnValidasi.setEnabled(akses.gettindakan_ranap());
