 ...
 * @author dosen
 */
public final class DlgPenanggungJawabEdit extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPenanggungJawabEdit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        label36.setText("Kategori :");
        label36.setName("label36"); // NOI18N
        label36.setPreferredSize(new java.awt.Dimension(35, 23));
        FormInput.add(label36);
        label36.setBounds(620, 10, 95, 23);
        ...
        label40.setText("Nama Asuransi :");
        label40.setName("label40"); // NOI18N
        label40.setPreferredSize(new java.awt.Dimension(35, 23));
        FormInput.add(label40);
        label40.setBounds(185, 10, 95, 23);

        jComboBox1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BPJS KESEHATAN", "BPJS TK", "Umum Asuransi", "Manage Care", "Jamkesda", "Paket", "-" }));
        jComboBox1.setName("kategori"); // NOI18N
        FormInput.add(jComboBox1);
        jComboBox1.setBounds(720, 10, 140, 20);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPenanggungJawabEdit dialog = new DlgPenanggungJawabEdit(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select penjab.kd_pj,penjab.png_jawab,penjab.nama_perusahaan,penjab.alamat_asuransi,penjab.no_telp,penjab.attn,penjab.kategori "+
