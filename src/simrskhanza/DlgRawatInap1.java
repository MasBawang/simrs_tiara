 ...
 * @author perpustakaan
 */
public final class DlgRawatInap1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRawatInap1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initRawatInap();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRawatInap1 dialog = new DlgRawatInap1(new javax.swing.JFrame(), true);
