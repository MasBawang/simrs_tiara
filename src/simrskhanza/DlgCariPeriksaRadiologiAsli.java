...
public class DlgCariPeriksaRadiologiAsli extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPeriksaRadiologiAsli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPeriksaRadiologiAsli dialog = new DlgCariPeriksaRadiologiAsli(new javax.swing.JFrame(), true);
