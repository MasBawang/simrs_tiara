...
import simrskhanza.DlgCariPeriksaRadiologiAsli;
    ...
    private void BtnNotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnNotaActionPerformed
            if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
                ...
                try{
                    ...
                    i = 0;
                    try{
                          biaya = (String)JOptionPane.showInputDialog(null,"Silahkan pilih nota yang mau dicetak!","Nota",JOptionPane.QUESTION_MESSAGE,null,new Object[]{"Nota", "Kwitansi", "Nota & Kwitansi","Kwitansi Piutang","Nota Paket",},"Nota");
                          switch (biaya) {
                                case "Nota":
                                      i=1;
                                      break;
                    ...
                    if(i>0){                       
                        ...
                        if(i==1){
                            ...
                            Valid.panggilUrl("billing/LaporanBillingPaket.php?petugas="+akses.getkode().replaceAll(" ","_")+"&tanggal="+DTPTgl.getSelectedItem().toString().replaceAll(" ","_")+"&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB());    
                        }
...
private void MnPeriksaLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeriksaLabActionPerformed
    ...
    private void MnCariRadiologiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCariRadiologiActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            DlgCariPeriksaRadiologiAsli periksalab=new DlgCariPeriksaRadiologiAsli(null,false);
            periksalab.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            periksalab.setLocationRelativeTo(internalFrame1);
            periksalab.SetNoRw(TNoRw.getText());  
            periksalab.setAlwaysOnTop(false);
