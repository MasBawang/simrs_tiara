...
public final class DlgPiutangRalan extends javax.swing.JDialog {
    ...
    public DlgPiutangRalan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"Tanggal","No.Nota","No.RM","Nama Pasien","Jenis Bayar","Perujuk",
                            ...
                            "Total","Ekses","Sudah Dibayar","Diskon Bayar","Tidak Terbayar","Sisa","Dokter","Nomor Rawat","Poliklinik","SEP BPJS"};
                    ...
                    case "Laporan 1 (HTML)":
                            ...
                            htmlContent.append(                             
                                "<tr class='isi'>").append(
                                    ...
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center'>Nomor Rawat</td>").append(
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center'>Poliklinik</td>").append(
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center'>SEP BPJS</td>").append(        
                                "</tr>"
                            ); 
                            for(i=0;i<tabMode.getRowCount();i++){  
                                htmlContent.append(                             
                                    "<tr class='isi'>").append(
                                        ...
                                        "<td valign='top' align='right'>").append(tabMode.getValueAt(i,20)).append("</td>").append(
                                        "<td valign='top' align='right'>").append(tabMode.getValueAt(i,21)).append("</td>").append(
                                        "<td valign='top' align='right'>").append(tabMode.getValueAt(i,22)).append("</td>").append(        
                                        "<td valign='top'>").append(tabMode.getValueAt(i,23)).append("</td>").append(
                                    "</tr>"
                                ); 
                            }            
    ...
    */
    ...
    public void tampil(){
        ...
        try{    
            ...
            ps= koneksi.prepareStatement("select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,reg_periksa.tgl_registrasi,dokter.nm_dokter,penjab.png_jawab,poliklinik.nm_poli, "+
                        "piutang_pasien.uangmuka,piutang_pasien.totalpiutang,COALESCE(bridging_sep.no_sep, '-') AS no_sep "+
                        ...
                        "LEFT join bridging_sep on bridging_sep.no_rawat=reg_periksa.no_rawat AND jnspelayanan=2 "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[] {
                        ...
                        rs.getString("no_rawat"),rs.getString("nm_poli"),rs.getString("no_sep")
                    });
                }
