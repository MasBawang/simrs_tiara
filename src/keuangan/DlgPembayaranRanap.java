...
public final class DlgPembayaranRanap extends javax.swing.JDialog {
    ...
    public DlgPembayaranRanap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"Tgl.Pulang","No.Nota","No.RM","Nama Pasien","Kamar/Bangsal","Perujuk","Registrasi","Tindakan","Obt+Emb+Tsl","Retur Obat","Resep Pulang",
                            "Laborat","Radiologi","Potongan","Tambahan","Kamar+Service","Operasi","Harian","Total","Cara Bayar"};
                    ...
                    case "Laporan 1 (HTML)":
                            ...
                            htmlContent.append(                             
                                "<tr class='isi'>"+
                                    ...
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='6%'>Cara Bayar</td>"+    
                                "</tr>"
                            ); 
        ...
        try{      
            if(nmbangsal.getText().equals("")&&NmCaraBayar.getText().equals("")){
                ps= koneksi.prepareStatement(
                    "select kamar_inap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,kamar_inap.tgl_keluar,bangsal.nm_bangsal,kamar_inap.stts_pulang,penjab.png_jawab, "+
                        ...
                        if(tampilkan.equals("Belum Bayar")&&Keterangan.equals("Belum Bayar")){
                            tabMode.addRow(new Object[]{
                                ...
                                Valid.SetAngka(Tambahan),Valid.SetAngka(Kamar+Service),Valid.SetAngka(Operasi),Valid.SetAngka(Harian),Valid.SetAngka(Laborat+Radiologi+Operasi+Obat+Ranap_Dokter+
                                        Ranap_Dokter_Paramedis+Ranap_Paramedis+Ralan_Dokter+Ralan_Dokter_Paramedis+Ralan_Paramedis+Tambahan+Potongan+Kamar+Registrasi+Harian+Retur_Obat+Resep_Pulang+Service),rs.getString("png_jawab")
                            });
