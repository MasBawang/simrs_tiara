...
public final class DlgPerkiraanBiayaRanap extends javax.swing.JDialog {
    ...
    public DlgPerkiraanBiayaRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Diagnosa Awal","ICD 10","Perkiraan Tarif","Limit","LOS","Kelas Hak","Cara Bayar","SEP BPJS","DPJP"
            }){
    ...
    public void tampil(){
        ...
        try{      
            ps= koneksi.prepareStatement(
                ...
                "kamar_inap.diagnosa_awal,penjab.png_jawab,COALESCE (if(bridging_sep.klsrawat='1','Kelas 1',if(bridging_sep.klsrawat='2','Kelas 2',if(bridging_sep.klsrawat='3','Kelas 3',NULL))),'-') as klsrawat,DATEDIFF(CURDATE(), reg_periksa.tgl_registrasi) + 1 AS lama, "+
                "COALESCE (bridging_sep.no_sep,'-')as no_sep,GROUP_CONCAT(dokter.nm_dokter SEPARATOR ', ') AS dpjp "+        
                "from kamar_inap "
                ...
                "GROUP BY kamar_inap.no_rawat order by bangsal.nm_bangsal");
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        Valid.SetAngka(Deposit),Valid.SetAngka(Deposit-Jumlah),rs.getString("diagnosa_awal"),diag,Valid.SetAngka(perkiraantarif),pros,rs.getString("lama"),rs.getString("klsrawat"),rs.getString("png_jawab"),rs.getString("no_sep"),rs.getString("dpjp")
                    });
