...
public final class DlgPiutangRanap extends javax.swing.JDialog {
    ...
    public DlgPiutangRanap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"Tgl.Pulang","No.Nota","No.RM","Nama Pasien","Jenis Bayar","Perujuk","Registrasi","Tindakan","Obt+Emb+Tsl","Retur Obat","Resep Pulang",
                            ...
                            "Tidak Terbayar","Sisa","Nama Kamar","SEP BPJS"};
                    ...
                    case "Laporan 1 (HTML)":
                            ...
                            htmlContent.append(                             
                                "<tr class='isi'>"+
                                    ...
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center'>SEP BPJS</td>"+    
                                "</tr>"
                            ); 
    ...
    public void tampil(){
        ...
        try{      
            ...
            ps= koneksi.prepareStatement(
                ...
                "penjab.png_jawab,kamar_inap.stts_pulang,kamar.kd_kamar, bangsal.nm_bangsal,piutang_pasien.uangmuka,piutang_pasien.totalpiutang,COALESCE (bridging_sep.no_sep,'-')as no_sep "+
                ...
                "left join bridging_sep on bridging_sep.no_rawat=piutang_pasien.no_rawat and bridging_sep.jnspelayanan='1' where "+          
                    ...
                    if(!rs.getString("stts_pulang").equals("-")){
                        if(!rs.getString("stts_pulang").equals("Pindah Kamar")){
                            ...
                            tabMode.addRow(new Object[]{
                                ...
                                Valid.SetAngka(ekses),Valid.SetAngka(dibayar),Valid.SetAngka(diskon),Valid.SetAngka(tidakdibayar),Valid.SetAngka(sisa),rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal"),rs.getString("no_sep")
                            });
