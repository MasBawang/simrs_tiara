...
public final class KeuanganRingkasanHutangVendorFarmasi extends javax.swing.JDialog {
    ...
    public KeuanganRingkasanHutangVendorFarmasi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={
            "Kode Suplier","Nama Supplier","Sisa Hutang","Umur Hutang"
        };
...
//                                Valid.SetAngka(Double.parseDouble(tabMode.getValueAt(i,2).toString()))+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Hutang"); 
            Sequel.menyimpan("temporary","'"+i+"','"+
            tabMode.getValueAt(i,0).toString()+"','"+   // kode supplier
            tabMode.getValueAt(i,1).toString()+"','"+   // nama supplier
            Valid.SetAngka(Double.parseDouble(tabMode.getValueAt(i,2).toString()))+"','"+ // sisa hutang
            tabMode.getValueAt(i,3).toString()+"',"+    // umur hutang (tambahan baru)
            "'','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Hutang");
            }
            i++;
    ...
    private void tampil(){
        ...
        try{
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "(SELECT ifnull(SUM(besar_bayar),0) FROM bayar_pemesanan where bayar_pemesanan.no_faktur=pemesanan.no_faktur)) as sisahutang,pemesanan.tgl_tempo,DATEDIFF(pemesanan.tgl_tempo, CURDATE()) AS umur_hutang "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("kode_suplier"),rs.getString("nama_suplier"),rs.getDouble("sisahutang"),rs.getDouble("umur_hutang")
                    });
