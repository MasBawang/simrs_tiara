...
public final class DlgPembayaranRalan extends javax.swing.JDialog {
    ...
    public DlgPembayaranRalan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"Tanggal","No.Nota","No.RM","Nama Pasien","Poli/Unit","Perujuk",
                            ...
                            "Total","Dokter","Keterangan","Cara Bayar"};
        ...
        try{      
            if(NmPoli.getText().equals("")&&NmCaraBayar.getText().equals("")&&NmDokter.getText().equals("")&&TCari.getText().equals("")){
                ps= koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,reg_periksa.tgl_registrasi,dokter.nm_dokter,poliklinik.nm_poli,penjab.png_jawab "+
                ...
                while(rs.next()){
                    ...
                    if(tampilkan.equals("Belum Bayar")&&Keterangan.equals("Belum Bayar")){
                        tabMode.addRow(new Object[] {
                            ...
                            rs.getString("nm_dokter"),Keterangan,rs.getString("png_jawab")
                        });
