...
public final class DlgDataInsidenKeselamatan extends javax.swing.JDialog {
    ...
    public DlgDataInsidenKeselamatan(java.awt.Frame parent, boolean modal) {
        ...
        Akibat.setDocument(new batasInput((int)1500).getKata(Akibat));
        Tindakan.setDocument(new batasInput((int)1500).getKata(Tindakan));
        Identifikasi.setDocument(new batasInput((int)1500).getKata(Identifikasi));
        TindakLanjut.setDocument(new batasInput((int)1500).getKata(TindakLanjut));
    ...
    private void initComponents() {
        ...
        Kejadian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-09-2025" }));
        ...
        Lapor.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-09-2025" }));
