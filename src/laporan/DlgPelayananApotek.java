...
public final class DlgPelayananApotek extends javax.swing.JDialog {
    ...
    public DlgPelayananApotek(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={
            "No.","No.RM","Nama Pasien","Dokter","Poli","Jam Peresepan","Jam Validasi","Jam Penyerahan","Peresepan-Validasi","Validasi-Penyerahan","Peresepan-Penyerahan","Cara Bayar"
        };
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                "select reg_periksa.no_rkm_medis,pasien.nm_pasien,dokter.nm_dokter,poliklinik.nm_poli,penjab.png_jawab, " +
                ...
                "from reg_periksa inner join dokter inner join pasien inner join poliklinik inner join resep_obat inner join penjab " +
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("durasipelayanan"),rs.getString("png_jawab")
                    });
                    i++;
