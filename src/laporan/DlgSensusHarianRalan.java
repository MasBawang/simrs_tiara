...
public final class DlgSensusHarianRalan extends javax.swing.JDialog {
    ...
    public DlgSensusHarianRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabmode=new DefaultTableModel(null,new String[]{
                ...
                "Pengunjung","Jenis Kunjungan","Jenis Kasus","Asal Instansi"
            }){
        ...
        if(TabRawat.getSelectedIndex()==0){
            if(tabmode.getRowCount()==0){
                ...
                for(int r=0;r<tabmode.getRowCount();r++){ 
                    Sequel.menyimpan("temporary_sensus_harian","'0',?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'','','','','','','','','','','','','','','','',''",22,new String[]{
                            ...
                            tabmode.getValueAt(r,18).toString(),tabmode.getValueAt(r,19).toString(),tabmode.getValueAt(r,20).toString(),tabmode.getValueAt(r,21).toString()
                    });
                }
            ...
            if(tabmode2.getRowCount()==0){
                ...
                for(int r=0;r<tabmode2.getRowCount();r++){ 
                    Sequel.menyimpan("temporary_sensus_harian","'0',?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'','','','','','','','','','','','','','','','',''",22,new String[]{
                            ...
                            tabmode2.getValueAt(r,18).toString(),tabmode2.getValueAt(r,19).toString(),tabmode2.getValueAt(r,20).toString(),tabmode.getValueAt(r,21).toString()
                    });
                }
    ...
    public void tampil(){        
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                       ...
                       "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,perusahaan_pasien.nama_perusahaan,"+
                       ...
                       "inner join kecamatan inner join kabupaten inner join perusahaan_pasien "+
                       "on reg_periksa.kd_dokter=dokter.kd_dokter and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                       "and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli "+
                       "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab and pasien.perusahaan_pasien=perusahaan_pasien.kode_perusahaan where "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabmode.addRow(new Object[]{
                        ...
                        Sequel.cariIsi("select status_penyakit from diagnosa_pasien where prioritas='1' and status='Ralan' and no_rawat=?",rs.getString("no_rawat")),rs.getString("nama_perusahaan")
                    });                    
                    i++;
                }
            } catch (Exception e) {
