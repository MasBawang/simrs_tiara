 ...
 * @author perpustakaan
 */
public final class DlgRl321 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRl321(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRl321 dialog = new DlgRl321(new javax.swing.JFrame(), true);
