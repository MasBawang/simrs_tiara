 ...
 * @author dosen
 */
public final class DlgPenyakit1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPenyakit1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPenyakit1 dialog = new DlgPenyakit1(new javax.swing.JFrame(), true);
