...
public final class DlgStatusDataRM extends javax.swing.JDialog {
    ...
    private int i=0,adasoapiralan=0,tidakadasoapiralan=0,adasoapiranap=0,tidakadasoapiranap=0,adaresumeralan=0,tidakadaresumeralan=0,
            adaresumeranap=0,tidakadaresumeranap=0,adatriaseigd=0,tidakadatriaseigd=0,adaaskepigd=0,tidakadaaskepigd=0,adamedisigd=0,tidakadamedisigd=0,adaicd10=0,tidakadaicd10=0,
            adaicd9=0,tidakadaicd9=0;  
    private String soapiralan="",soapiranap="",resumeralan="",resumeranap="",pilihan="",triaseigd="",askepigd="",medisigd="",icd10="",icd9="";
    ...
    public DlgStatusDataRM(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","Tanggal","Dokter Dituju","Nomer RM","Pasien","Poliklinik","Status","SOAPI Ralan","SOAPI Ranap","Resume Ralan","Resume Ranap","Triase IGD","Askep IGD","Medis IGD","ICD 10","ICD 9"
        }){
                    ...
                    case "Laporan 1 (HTML)":
                            ...
                            htmlContent.append(                             
                                "<tr class='isi'>"+
                                    ...
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='70px'>Medis IGD</td>"+
                    ...
                    case "Laporan 2 (WPS)":
                            ...
                            htmlContent.append(                             
                                "<tr class='isi'>"+
                                    ...
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='70px'>Triase IGD</td>"+
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='70px'>Askep IGD</td>"+
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='54px'>Medis IGD</td>"+
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='54px'>ICD 10</td>"+
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='54px'>ICD 9</td>"+
                                "</tr>"
                            ); 
                    ...
                    case "Laporan 3 (CSV)":
                            ...
                            for(i=0;i<tabMode.getRowCount();i++){  
                                htmlContent.append(                             
                                    ...
                                    "\""+tabMode.getValueAt(i,10)+"\";\""+tabMode.getValueAt(i,11)+"\";\""+tabMode.getValueAt(i,12)+"\";\""+tabMode.getValueAt(i,13)+"\";\""+tabMode.getValueAt(i,14)+"\";\""+tabMode.getValueAt(i,15)+"\"\n"
                                ); 
                            }            
    ...
    public void tampil(){        
        try{   
            ...
            try {
                ...
                adatriaseigd=0;tidakadatriaseigd=0;adaaskepigd=0;tidakadaaskepigd=0;adamedisigd=0;tidakadamedisigd=0;adaicd10=0;tidakadaicd10=0;adaicd9=0;tidakadaicd9=0; 
                while(rs.next()){
                    ...
                    medisigd=Sequel.cariIsi("select if(count(penilaian_medis_igd.no_rawat)>0,'Ada','Tidak Ada') from penilaian_medis_igd where penilaian_medis_igd.no_rawat=?",rs.getString("no_rawat"));
                    if(medisigd.equals("Ada")){
                        adamedisigd++;
                    }else{
                        tidakadamedisigd++;
                    }
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        soapiralan,soapiranap,resumeralan,resumeranap,triaseigd,askepigd,medisigd,icd10,icd9
                    });                    
                }
                if(tabMode.getRowCount()>0){
                    tabMode.addRow(new Object[]{
                        "","","","","","Status Data Ada",":",adasoapiralan,adasoapiranap,adaresumeralan,adaresumeranap,adatriaseigd,adaaskepigd,adamedisigd,adaicd10,adaicd9
                    });
                    tabMode.addRow(new Object[]{
                        "","","","","","Status Data Tidak Ada",":",tidakadasoapiralan,tidakadasoapiranap,tidakadaresumeralan,tidakadaresumeranap,tidakadatriaseigd,tidakadaaskepigd,tidakadamedisigd,tidakadaicd10,tidakadaicd9
                    });
                }   
            } catch (Exception e) {
