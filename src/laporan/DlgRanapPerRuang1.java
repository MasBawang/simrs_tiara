 ...
 * @author perpustakaan
 */
public final class DlgRanapPerRuang1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRanapPerRuang1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRanapPerRuang1 dialog = new DlgRanapPerRuang1(new javax.swing.JFrame(), true);
